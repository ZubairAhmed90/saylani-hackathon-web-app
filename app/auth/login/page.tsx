...
export default function LoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description: "Welcome back to GeekCode!",
      })
    } catch (error: any) {
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      toast({
        title: "Login successful",
        description: "Welcome to GeekCode!",
      })
    } catch (error: any) {
        ...
        <Card className="bg-[#1A1A1A] border-gray-800">
            ...
            <form onSubmit={handleLogin} className="space-y-4">
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <Link href="/auth/forgot-password" className="text-sm text-[#00FFBF] hover:underline">
                    Forgot password?
                  </Link>
                </div>
                <Input
          ...
          <CardFooter className="flex justify-center">
            <p className="text-sm text-gray-400">
              ...
              <Link href="/auth/signup" className="text-[#00FFBF] hover:underline">
                Sign up
              </Link>
            </p>
          </CardFooter>
